...
declare type native_to_scval_options = {
  type?: scval_type;
};


declare function nativeToScVal(
  value: any,
...
declare let result: any;
      `,
      "ts:filename/sorobuild-script-runtime.d.ts"
    );
  }
...
function PreviewPanel({ preview, getPreviewSummary }) {
  if (!preview) return null;

  return (
    <div className="mt-4 rounded-2xl border border-emerald-200 bg-emerald-50 shadow-sm">
      ...
      <div className="max-h-56 overflow-auto px-4 py-4 sm:max-h-64">
